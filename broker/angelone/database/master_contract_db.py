...
def process_angel_json(path):
    ...
    # and normalize to Best-Option common format (uppercase, no spaces/hyphens)
    ...
    # and normalize to Best-Option common format (uppercase, no spaces/hyphens, remove S&P prefix)
    ...
    # Override for major indices where normalized name differs from Best-Option standard
