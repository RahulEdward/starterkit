...
def transform_margin_positions(positions):
    """
    Transform Best-Option margin position format to Fyers margin format.
...
def parse_margin_response(response_data):
    """
    Parse Fyers margin response to Best-Option standard format.
    ...
    try:
        ...
        # Return standardized format matching Best-Option specification
