# Mapping Best-Option API Request https://Best-Option.in/docs
...
def transform_data(data):
    """
    Transforms the Best-Option Platform API request structure to the format expected by the Fyers API.
    """
...
def map_order_type(pricetype):
    """
    Maps the Best-Option pricetype to the Fyers order type.
    """
...
def map_action(action):
    """
    Maps the Best-Option action to the Fyers side.
    """
...
def map_product_type(product):
    """
    Maps the Best-Option product type to the Fyers product type.
    """
...
def reverse_map_product_type(product):
    """
    Reverse maps the Fyers product type to the Best-Option product type.
    """
    ...
    if oa_product is None:
        logger.warning(
            f"Unknown Fyers product type '{product}' received. Cannot map to Best-Option product type."
        )
    return oa_product
